...
const signup = () => {
  return (
    <div className="bg-gray-200 min-h-screen">
      ...
      <Tabs defaultValue="account" className="relative bottom-10 top-52 shadow-xl flex-col h-full">
      <TabsList className="grid grid-cols-2 bg-black space-x-2 justify-center items-center ">
        <TabsTrigger value="account" className="text-white shadow-xl bg-black">Account</TabsTrigger>
        <TabsTrigger value="password" className=" text-white shadow-xl bg-black">Password</TabsTrigger>
      </TabsList>
      ...
      <TabsContent value="account" className="w-fit h-fit shadow-xl">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Create your new Account. If you already have an account <Link href={"/Login"} className="text-blue-500 hover:text-blue-600">Click Me.</Link>
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-2">

            <div className="space-y-1 text-left">
              <Label htmlFor="username" className="text-base font-bold">Name</Label>
      ...
      <TabsContent value="password" className="w-fit h-fit shadow-xl">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enter your Password to Login. If You don&apos;t have an account <Link href={"/Login"} className="text-blue-500 hover:text-blue-600">Click Me.</Link>
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-2">
                <div className="space-y-1 text-left">
